...
from Non_IID_pc10c_data_utils import getdataset
from new_model import cnn_2layer_fc_model, cnn_3layer_fc_model, ResNet18, ResNet34, ResNet152, ResNet101, ResNet50, mobilenetv2, shufflenetv2
from my_weight_engine import train_models,FedMD
...
def pretrain(pre_train_data,config_info):
    ...
    for i, item in enumerate(conf_dict["models"]):
        ...
        tmp = CANDIDATE_MODELS[model_name](num_classes=n_classes)
